...
. An external audit against operational and historical catalogues agreed with 80\% of assessable object-level endpoints, Wilson 95\% [0.688, 0.875], with all 14 contradictions retained and examined%
...
. Both delta-v pricings are reported throughout this paper: the perigee-speed pricing registered at \path{62f98d3} is primary, and the circular-speed convention of the published odometer is retained beside it, where the same statistic is 1.81\% and 46 of 54%
